...
const arr=["cross.jpeg","zero.jpeg","cross.jpeg","zero.jpeg","cross.jpeg","zero.jpeg","cross.jpeg","zero.jpeg","cross.jpeg"];
...
function makeMove(val){
    if(flag==1){
        ...
        a.innerHTML += `<img src="tttimg/${arr[i]}" width="120px" height="100px">`;
                i++; 
            console.log(val);
...
function final(){
    ...
    for (var i in win){
        ...
        if((a==b && b==c)&&(a==`<img src="tttimg/cross.jpeg" width="120px" height="100px">`)){
            document.getElementById("result").innerHTML=`${player1} wins :)`;
            flag=0;
        }
        else if((a==b && b==c)&&(a==`<img src="tttimg/zero.jpeg" width="120px" height="100px">`)){
